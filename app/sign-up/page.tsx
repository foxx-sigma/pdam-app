      ...
      <div className="w-full max-w-md">
        <div className="bg-white rounded-3xl shadow-lg p-8">
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-gray-500">Register for PDAM System</p>
          </div>
          ...
          <div className="space-y-4">
            ...
            <div className="flex items-center">
              ...
              <label htmlFor="terms" className="ml-2 text-sm text-gray-600">
                I agree to <span className="text-blue-600 font-semibold">Terms & Conditions</span>
              </label>
            </div>

            <button
              onClick={handleSignUp}
              className="w-full bg-gradient-to-r from-blue-500 to-blue-600 text-white py-3 rounded-xl font-semibold hover:from-blue-600 hover:to-blue-700 transition-all duration-200 shadow-md hover:shadow-lg"
            >
              Sign up
            </button>
          </div>
